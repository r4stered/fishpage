...
_ROWS = [
    ...
    (72.0, [(_SKU_X, "SKU"), (_SIZE_X, "SIZE"), (_NAME_X, "NAME"),
            (_RETAIL_DOLLAR_X, "RETAIL"), (_SPECIAL_DOLLAR_X, "SPECIAL"), (_QTY_X, "QTY")]),
    # Good row, retail only.
    (92.0, [(_SKU_X, "100001"), (_SIZE_X, "M"), (_NAME_X, "Tetra"), (_NAME_X2, "Neon"),
            (_RETAIL_DOLLAR_X, "$"), (_RETAIL_VAL_X, "5.99"), (_QTY_X, "10")]),
    # Malformed data row: 6-digit SKU but the QTY column is missing.
    (112.0, [(_SKU_X, "100002"), (_SIZE_X, "S"), (_NAME_X, "Barb"), (_NAME_X2, "Tiger"),
             (_RETAIL_DOLLAR_X, "$"), (_RETAIL_VAL_X, "3.99")]),
    # Good row, with a special price.
    (132.0, [(_SKU_X, "100003"), (_NAME_X, "Pleco"), (_NAME_X2, "Gold"),
             (_RETAIL_DOLLAR_X, "$"), (_RETAIL_VAL_X, "19.99"),
             (_SPECIAL_DOLLAR_X, "$"), (_SPECIAL_VAL_X, "14.99"), (_QTY_X, "2")]),
    # Malformed data row: the retail price token is non-numeric.
    (152.0, [(_SKU_X, "100004"), (_NAME_X, "Goby"), (_NAME_X2, "Bumblebee"),
             (_RETAIL_DOLLAR_X, "$"), (_RETAIL_VAL_X, "N/A"), (_QTY_X, "5")]),
    # Good row: the retail price carries a thousands separator.
    (172.0, [(_SKU_X, "100005"), (_NAME_X, "Arowana"), (_NAME_X2, "Super"), (_NAME_X3, "Red"),
             (_RETAIL_DOLLAR_X, "$"), (_RETAIL_VAL_X, "1,299.00"), (_QTY_X, "1")]),
    # Malformed data row: the QTY column is non-numeric.
    (192.0, [(_SKU_X, "100006"), (_NAME_X, "Snail"), (_NAME_X2, "Mystery"),
             (_RETAIL_DOLLAR_X, "$"), (_RETAIL_VAL_X, "4.99"), (_QTY_X, "CALL")]),
    ...
    (212.0, [(_SKU_X, "6/19/26"), (_NAME_X, "Freshwater"), (_NAME_X2, "Stocklist"),
             (_RETAIL_DOLLAR_X, "$"), (_RETAIL_VAL_X, "0.00"), (_QTY_X, "0")]),
    # Non-data line that is all-digits but not SKU length (a page-footer number).
    (232.0, [(_SKU_X, "12345"), (_NAME_X, "Page"), (_NAME_X2, "footer"),
             (_RETAIL_DOLLAR_X, "$"), (_RETAIL_VAL_X, "0.00"), (_QTY_X, "0")]),
]
